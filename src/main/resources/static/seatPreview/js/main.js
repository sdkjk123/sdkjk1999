...
;(function(window) {
	...
	var support = {transitions : Modernizr.csstransitions},
		...
		initTransform = {
			translateX : 0,
			translateY : 200, // view from top..
			translateZ : -1111,// TODO
			rotateX : -5, // ..looking down
			rotateY : 0
		},
	...
	function init() {
		...
		applyRoomTransform({'translateX' : 0, 'translateY' : 0, 'translateZ' : 11111, 'rotateX' : 0, 'rotateY' : 0});
		// bind events
		initEvents();
	}
